    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-center text-slate-800 mb-2">Şeffaf Danışmanlık</h1>
          <p className="text-slate-600">Sigorta Yönetim Sistemi</p>
        </div>
        ...
        <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-sm">
          <CardHeader className="space-y-1 pb-6">
            ...
            <CardDescription className="text-center text-slate-600">Hesabınıza giriş yapın</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <button type="button" className="text-[#0B3D91] hover:text-[#F57C00] transition-colors">
                  Şifremi unuttum
                </button>
              </div>
            ...
            <div className="mt-6 p-4 bg-slate-50 rounded-lg border border-slate-200">
              <p className="text-xs text-slate-600 text-center mb-2 font-medium">Demo Hesap Bilgileri:</p>
              <div className="text-xs text-slate-500 space-y-1">
                <p>
                  <strong>E-posta:</strong> admin@oksijen.com
                </p>
                <p>
